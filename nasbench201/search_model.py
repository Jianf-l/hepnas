...
from distill_loss import DMLLoss, KDLoss, MultiTeacherLoss
...
class TinyNetwork(nn.Module):
    ...
    def step(self, input, target, args, shared=None, return_grad=False, teacher=None, others=None):
    ...
    def set_arch_parameters(self, new_alphas):
        assert isinstance(new_alphas, list)
